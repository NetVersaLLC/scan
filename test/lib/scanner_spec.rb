...
describe 'Scanner' do
  ...
  it 'should send result to the scanserver thorugh api callback' do
    sample_callback_data = {
        'scan' => {'id' => '123',
                  "listed_name" => "Inkling Tattoo Gallery",
                  "listed_url" => "http://foursquare.com/v/inkling-tattoo-gallery/4f6a372ae4b068b1a70520d3",
                  "listed_address" => "3904 E Chapman Ave, OrangeCA, 92869",
                  "listed_phone" => "",
                  "status" => 'claimed'},
    ...
    scanner = Scanner.new('Foursquare', sample_data(0), 'localhost', 80)
  ...
  describe 'http_client' do
    it 'should use ssl when callback_port is 443 ' do
      ...
      scanner.http_client.verify_mode.should == OpenSSL::SSL::VERIFY_PEER
    end

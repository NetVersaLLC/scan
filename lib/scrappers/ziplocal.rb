class Ziplocal < AbstractScrapper
  # http://www.ziplocal.com/list.jsp?lang=0&nt=N&na=Inkling%20Tattoo%20Gallery&ct=92869
  # Request:
  # - Business name
  # - ZIP
  # Sort:
  ...
  def execute
    url = "http://www.ziplocal.com/list.jsp?lang=0&nt=N&na=#{URI::encode(@data['business'])}&ct=#{@data['zip']}"
